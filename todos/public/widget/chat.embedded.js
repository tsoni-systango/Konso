(function (window, document, callback) {
    ...
    if (!(j = window.jQuery) || callback(j, loaded)) {
        ...
        script.src = "//"+IM_CHAT_WIDGET_EMBEDDED.host + "/widget/jquery-1.11.1.min.js";
    ...
    function init() {
        ...
        var iframe = $("<iframe id='" + id + "-iframe' src='//" + IM_CHAT_WIDGET_EMBEDDED.host + "/embedded' width='" + width + "' height='" + height + "'></iframe>");
        ...
        window.addEventListener("message", function (e) {
            if (IM_CHAT_WIDGET_EMBEDDED.host.indexOf(e.origin) !== -1) {
